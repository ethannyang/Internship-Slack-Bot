...
CATEGORIES = [
    {
        ...
        "parent_texts": [
            "new SWE roles just dropped 👀",
            "SWE internships updated — go apply",
            "fresh SWE listings are in 🖥️",
            "more SWE roles added — don't sleep on these",
            "SWE internship update 🚀",
        ],
    },
    {
        ...
        "parent_texts": [
            "new PM roles just dropped 👀",
            "PM internships updated — go apply",
            "fresh PM listings are in 💼",
            "more PM roles added — don't sleep on these",
            "PM internship update 🚀",
        ],
    },
    {
        ...
        "parent_texts": [
            "new AI/ML roles just dropped 👀",
            "AI/ML internships updated — go apply",
            "fresh AI/ML listings are in 🤖",
            "more AI/ML roles added — don't sleep on these",
            "AI/ML internship update 🚀",
        ],
    },
